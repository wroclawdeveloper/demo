 ...
 */
final class Version20180621182151 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE person CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE address address VARCHAR(500) NOT NULL, CHANGE birth_date birth_date DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE person CHANGE id id INT UNSIGNED AUTO_INCREMENT NOT NULL, CHANGE address address TEXT DEFAULT NULL COLLATE utf8_general_ci, CHANGE birth_date birth_date DATETIME DEFAULT NULL');
